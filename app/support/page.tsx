...
export const metadata: Metadata = {
  title: 'Support Center | Oneho',
  description: 'Get help with your Oneho products. Email, phone, and live chat support available. Access installation guides, FAQs, and technical documentation.',
  openGraph: {
    title: 'Support Center | Oneho',
    description: 'Get help with your Oneho products. Email, phone, and live chat support available. Access installation guides, FAQs, and technical documentation.',
    type: 'website',
        ...
        <section className="bg-secondary py-20 md:py-28">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              All ONEHO products come with a 2-year warranty and 30-day return policy. We stand behind the quality of our hardware.
            </p>
            <Link
              href="/shop"
