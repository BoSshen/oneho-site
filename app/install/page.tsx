...
export const metadata: Metadata = {
  title: 'Installation Guides | Oneho',
  description: 'Step-by-step installation guides for all Oneho products. Download manuals, watch video tutorials, and access troubleshooting resources.',
  openGraph: {
    title: 'Installation Guides | Oneho',
    description: 'Step-by-step installation guides for all Oneho products. Download manuals, watch video tutorials, and access troubleshooting resources.',
    type: 'website',
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Everything you need to install and configure your ONEHO hardware products
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
              ...
              <div className="border border-border bg-card p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Watch step-by-step video guides for installing and configuring your ONEHO products.
                </p>
